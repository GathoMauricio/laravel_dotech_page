      ...
      <div class="container">
        ...
        <div class = "row">
            ...
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/soporte_tecnico_sitio_bg.jpg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_1') }}" target = "_blank"><h5>National technical support on site and remote</h5></a>
         ...
         <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/punto_venta.jpeg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_2') }}" target = "_blank"><h5>Point of sale software – TCPOS</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/punto_venta2.png') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_3') }}" target = "_blank"><h5>Point of sale hardware</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/cableado_estructurado.jpg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_4') }}" target = "_blank"><h5>STRUCTURED CABLING, FIBER</h5></a>
        ...
        <div class = "row">
            ...
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/video_vigilancia.jpeg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_5') }}" target = "_blank"><h5>VIDEO SURVEILLANCE</h5></a>
         ...
         <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/red_contra_incendios.jpg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_6') }}" target = "_blank"><h5>FIRE NETWORK</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/equipo_computo.jpg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_7') }}" target = "_blank"><h5>SALE OF COMPUTER EQUIPMENT</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/respaldo_nube.jpg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_8') }}" target = "_blank"><h5>CLOUD BACKUP</h5></a>
        ...
        <div class = "row">
            ...
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/hospedaje_web.jpg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_9') }}" target = "_blank"><h5>WEB HOSTING</h5></a>
          ...
          <div class="col-md-6 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              <div class="img-team">
                <img src="{{ asset('images/control_acceso.jpg') }}" alt="" class="img-circle">
              </div>

              <h3></h3>
                <a href = "{{ route('en','service_10') }}" target = "_blank"><h5>ACCESS CONTROL</h5></a>
