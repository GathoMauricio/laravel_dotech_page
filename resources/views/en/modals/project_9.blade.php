<div class="modal-full" id = "modal_full_9">
    <div class="modal-full-content">
      <span onclick= "$('#modal_full_9').css('display','none');" class="icon-cross" style="float: right;font-size:16px;font-weight:bold;cursor:pointer;"></span>
      <!-- Swiper -->
