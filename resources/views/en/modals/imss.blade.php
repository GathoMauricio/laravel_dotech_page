<div class="modal-full" id = "modal_full_imss">
    <div class="modal-full-content">
      <span onclick= "$('#modal_full_imss').css('display','none');" class="icon-cross" style="float: right;font-size:16px;font-weight:bold;cursor:pointer;"></span>
      <h3 class="text-center">IMSS</h3>
      <p>
          <img src="{{ asset('gallery/img/clientes/imss.png') }}" alt="" style="float:left;padding:10px;"/>
