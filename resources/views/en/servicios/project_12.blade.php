...
<section id="about" class="light p-2">
    <h3 class ="text-center">FAMILY MEDICAL UNIT 17 IMSS MAGDALENA APASCO OAXACA</h3>
        ...
        <p>
            <ol>
                <li>Voice and Data Network Installation</li>
                <li>Server, Licensing.</li>
                <li>Voip switch.</li>
                <li>Wifi network</li>
                <li>CCTV Video Surveillance.</li>
                <li>Fire alarm.</li>
                <li>Entertainment and Broadcasting System.</li>
            </ol>
        </p>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_1.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/2.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_2.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/3.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_3.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/4.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_4.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/5.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_5.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/6.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_6.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/7.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_7.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/8.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_8.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/9.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_9.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_12/10.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_12/img_10.png') }}" alt="#"/></a>
            <figcaption>
