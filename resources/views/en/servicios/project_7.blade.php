...
<section id="about" class="light p-2">
    <h3 class ="text-center">Papa Johns Lindavista</h3>
        ...
        <p>
            <ol>
                <li>Supply and installation of Data Cabling, Patch Panel, Poe Switch, Cabinet, Access Point, data processing.</li>
                <li>Installation of Services for Point of Sale, Make Line, Delivery.</li>
                <li>Supply and installation of voice cabling.</li>
                <li>Supply and Installation of Menu (3 Tvs 32 ”).</li>
                <li>Supply and installation of Television and Audio Network Entertainment.</li>
                <li>Supply and installation of Security and Video Surveillance System.</li>
                <li>Supply and installation of Printers, Nobreaks and Voltage corrector</li>
            </ol>
        </p>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_7/img_1.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/2.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_7/img_2.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/3.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_7/img_3.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/4.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_7/img_4.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/5.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_7/img_5.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/6.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_7/img_6.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/7.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_1/img_7.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_7/8.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_1/img_8.png') }}" alt="#"/></a>
            <figcaption>
