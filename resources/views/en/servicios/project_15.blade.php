...
<section id="about" class="light p-2">
    <h3 class ="text-center">Monterrey-Saltillo Readers Facility</h3>
        <h5 class ="text-center">
            Project: ITS installations in the Monterrey Saltillo section
        </h5>
        <h4 class ="text-center"><b>Year:</b> 2016</h4>
        <p>
            <ol>
                <li>Installing Readers</li>
                <li>Installation of RFID antennas</li>
                <li>Wiring LMR-400 LMR-600</li>
                <li>Toll booth wiring to power registers.</li>
            </ol>
        </p>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_1.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/2.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_2.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/3.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_3.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/4.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_4.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/5.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_5.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/6.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_6.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/7.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_7.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/8.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_8.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/9.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_9.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_15/10.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_15/img_10.png') }}" alt="#"/></a>
            <figcaption>
