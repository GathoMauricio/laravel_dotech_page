...
<section id="about" class="light p-2">
    <h3 class ="text-center">Without Cola 5LA Movistar Nacional.</h3>
        ...
        <p>
            <ol>
                ...
                <li>Kiosk installation.</li>
                <li>server installation and operators.</li>
                <li>User training.</li>
                <li>Live Out Accompaniment.</li>
            </ol>
        </p>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_11/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_11/img_1.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_11/2.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_11/img_2.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_11/3.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_11/img_3.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_11/4.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_11/img_4.png') }}" alt="#"/></a>
            <figcaption>
