...
<section id="about" class="light p-2">
    <h3 class ="text-center">Pizza danny's Monclova branch</h3>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_1.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/2.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_2.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/3.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_3.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/4.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_4.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/5.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_5.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/6.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_6.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/7.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_7.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_2/8.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_2/img_8.png') }}" alt="#"/></a>
            <figcaption>
