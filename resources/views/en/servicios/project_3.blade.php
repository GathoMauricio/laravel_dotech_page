...
<section id="about" class="light p-2">
    <h3 class ="text-center">Macro Bypass Guadalajara.</h3>
        ...
        <p>
            <ol>
                ...
                <li>Fixing of Banner Type Posts.</li>
                <li>Installation and testing of PMV..</li>
             </ol>
        </p>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_3/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_3/img_1.png') }}" alt="#"/></a>
            <figcaption>
