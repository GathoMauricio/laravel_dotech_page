...
<section id="about" class="light p-2">
    <h3 class ="text-center">Papa Johns Renewal of wiring</h3>
        <h5 class ="text-center">
            Renovation of structured cabling to 29 Papa Johns Stores (250 Nodes)
        </h5>
        <h4 class ="text-center"><b>Year:</b> 2018</h4>
        <p>
            <ol>
                <li>Supply and installation of Data Cabling, Patch Panel, Cabinet, cable organizer.</li>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_5/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_5/img_1.png') }}" alt="#"/></a>
            <figcaption>
