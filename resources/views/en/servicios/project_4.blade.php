...
<section id="about" class="light p-2">
    <h3 class ="text-center">Guadalajara Tepic Highway.</h3>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_4/1.jpeg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_4/img_1.png') }}" alt="#"/></a>
            <figcaption>
