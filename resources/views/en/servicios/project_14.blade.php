...
<section id="about" class="light p-2">
    <h3 class ="text-center">Alebrijes Stadium of Oaxaca</h3>
        <h5 class ="text-center">
            Project: Design Executive Project for special facilities Alebrijes Stadium Oaxaca
        </h5>
        <h4 class ="text-center"><b>Year:</b> 2013</h4>
        <p>
            <ol>
                <li>Voice and Data Communications Network</li>
...
<section id="photostack-1" class="photostack">
    <div>
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/1.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_1.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/2.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_2.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/3.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_3.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/4.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_4.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/5.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_5.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/6.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_6.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/7.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_7.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/8.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_8.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/9.jpg') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_9.png') }}" alt="#"/></a>
            <figcaption>
        ...
        <figure>
            <a href="{{ asset('gallery/img/proyecto_14/10.png') }}" class="photostack-img" target="_blank"><img src="{{ asset('gallery/img/proyecto_14/img_10.png') }}" alt="#"/></a>
            <figcaption>
