      ...
      <div class="container">
        ...
        <div class = "row">
            ...
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_1') }}" ><h5>SOPORTE TECNICO EN SITIO Y REMOTO NACIONAL</h5></a>
         ...
         <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_2') }}" ><h5>SOFTWARE DE PUNTO DE VENTA – TCPOS</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_3') }}" ><h5>HARDWARE DE PUNTO DE VENTA</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_4') }}" ><h5>CABLEADO ESTRUCTURADO, FIBRA.</h5></a>
        ...
        <div class = "row">
            ...
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_5') }}" ><h5>VIDEO VIGILANCIA</h5></a>
         ...
         <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_6') }}" ><h5>RED CONTRA INCENDIOS</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_7') }}" ><h5>VENTA EQUIPO DE COMPUTO</h5></a>
          ...
          <div class="col-md-3 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_8') }}" ><h5>RESPALDO EN LA NUBE</h5></a>
        ...
        <div class = "row">
            ...
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_9') }}" ><h5>HOSPEDAJE WEB</h5></a>
          ...
          <div class="col-md-6 text-center">
            <div class="wrap animated" data-animate="fadeInDown">
              ...
              <h3></h3>
                <a href = "{{ route('es','service_10') }}" ><h5>CONTROL DE ACCESO</h5></a>
