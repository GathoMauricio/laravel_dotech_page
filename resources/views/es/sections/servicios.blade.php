<section id="titulo_servicios" class="wrapper style3">
    <div class="inner">
					...
					<div class="grid-style">
                        ...
                        <div>
							<div class="box">
								...
								<div class="content">
									<header class="align-center">
										<h2>SOFTWARE DE PUNTO DE VENTA – TCPOS</h2>
									</header>
                        ...
                        <div>
							<div class="box">
								...
								<div class="content">
									<header class="align-center">
										<h2>HARDWARE DE PUNTO DE VENTA</h2>
									</header>
                        ...
                        <div>
							<div class="box">
								...
								<div class="content">
									<header class="align-center">
										<h2>CABLEADO ESTRUCTURADO, FIBRA.</h2>
									</header>
